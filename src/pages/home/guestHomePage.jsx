...
import LoginModalForm from "../../components/login/loginModalForm.jsx";
...
export default function GuestHomePage() {
    ...
    return (<div>
        <GuestLayouts myOnClick={myOnClick}/>
        ...
        <div className="container-fluid background-green">
            <div className="row p-5 pt-3">
                    ...
                    <div>
                        <div>
                            ...
                            <p className="fs-5 mb-5 me-5">
                                ...
                                интернет-магазина. Мы доставим ваш заказ бесплатно в любой город РФ осуществим подробную
                                консультацию по товарам и поможем с выбором.
                            </p>
                            <button type="button" className="btn border text-white px-4 rounded-4 me-3 mb-5">Связаться с
                                нами
                            </button>
                            <button type="button" className="btn btn-primary text-white px-4 rounded-4 mb-5">Обратиться
                                в
                                сервис
                            </button>
                        </div>
                ...
                <div className="col-5">
                    <RegisterForm myOnClick={myOnClick}/>
                </div>
            </div>
        </div>
